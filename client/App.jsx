...
//  console.log('values.period',values.period);

// check if motion was detected recently to show red triangle
  const outOfRange = differenceInSeconds( new Date(),new Date(lastData.data.allStMains.nodes[0].dtCrt) ) > values.period; //60*10;
